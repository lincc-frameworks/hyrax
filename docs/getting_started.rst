...
explore astronomy-focused example notebooks. If you are new to Hyrax, read the following
pages in order:
...
#. :doc:`Astronomy Supervised <pre_executed/supervised_lightcurve_transients_gs>`
