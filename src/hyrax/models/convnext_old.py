...
class HyraxConvNeXt(nn.Module):
    ...
    def __init__(self, config, data_sample=None):
        ...
        # Number of classes
        self.num_classes = config["model"]["ConvNeXt"]["num_classes"]
    ...
    def _init_encoder(self):
        # Initialize the model without weights as the model was trained using conventional RBG images
    ...
    def train_batch(self, batch):
        ...
        # TODO: Properly implement the loss computation
        # What should I compare the representation with since we don't have a decoder?
