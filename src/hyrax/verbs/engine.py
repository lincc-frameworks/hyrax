...
class Engine(Verb):
    ...
    def run(self, model_directory: str = None):
        ...
        [x] Pass the collated batch to the appropriate prepare_inputs function
        ...
        # ~ Find the directory that contains the ONNX model, prepare_inputs.py or to_tensor.py, etc.
        if model_directory:
